...
echo '<div class="container outercont">';
    ...
    ?>
    <div id="page-content" class="row containerLogin">

        <section class="col-md-6 image">
            <img class="iconLabel" src="<?php echo $OUTPUT->image_url('login', 'theme'); ?>"> 
        </section>

        
        <section id="region-main" class="col-md-6">

            <h1 class="titleLogin">Bienvenido</h1>
